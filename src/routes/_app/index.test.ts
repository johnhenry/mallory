...
test("dashboard CARDS covers every route file under src/routes/_app/ (except index.tsx and the shell)", () => {
...
test("dashboard CARDS specifically includes recently-added panels (Tiles, Streaming, Digit Classifier, Cellular Automata)", () => {
  ...
  assert.ok(cardPaths.includes("/digit-classifier"), "Digit Classifier panel missing from dashboard grid");
